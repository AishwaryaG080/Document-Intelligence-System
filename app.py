...
#                using RAG and Local Ollama Engine
#
# Description  :
# This project allows the user to upload a PDF document and ask
# questions based on its content. The system uses a clean RAG 
# architecture with keyword overlap matching and a completely local 
# Ollama endpoint to generate answers without any API keys.
# =========================================================
...
# Description   : Extracts readable text page-by-page from an uploaded PDF.
# Input         : Uploaded PDF file object
# Output        : List of string pages
# =========================================================
...
# =========================================================
# Function Name : search_relevant_context
# Description   : Simple retrieval logic checking word-level intersections.
# Input         : User query (string), Document Pages (list)
# Output        : Most relevant string page
# =========================================================
...
# Description   : Renders the execution map visually on UI.
# =========================================================
...
# Refined Minimalist Corporate Theme Injection
st.markdown("""
<style>
                ...
                with st.chat_message("assistant"):
                    if not retrieved_context:
                        ...
                        with st.spinner("Generating inference using local Ollama model..."):
                            # Send context and query to our local HTTP function
